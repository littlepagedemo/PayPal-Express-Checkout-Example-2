...
<?php 	} ?>				
				...
				<!-- First entry point - Shopping cart express checkout 1 -->
...
?>					
		...
		<div id="aside">
			...
			<p>User will be directed to the PayPal site and come back to select Shipping method and make payment here.<br><br>
			</p>
